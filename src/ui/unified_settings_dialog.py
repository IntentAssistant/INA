...
class UnifiedSettingsDialog(QDialog):
    ...
    def create_models_page(self):
        ...
        current_api_key = api_manager.get_api_key(current_provider) if current_provider else ""
        current_model = api_manager.get_model(current_provider) if current_provider else None
    ...
    def create_notifications_page(self):
        ...
        notification_info = QLabel("Notifications are managed by macOS system preferences")
